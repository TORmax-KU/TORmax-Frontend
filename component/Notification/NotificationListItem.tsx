...
export function NotificationListItem({
    ...
    return (
        <div
            className={`p-4 rounded-2xl border transition-all flex gap-3 sm:gap-4 items-start ${!item.read
        ...
        >
            ...
            <div className="flex items-center gap-1 shrink-0 pt-0.5">
                <button
                    ...
                    className={`w-2 h-2 rounded-full transition-colors ${!item.read ? 'bg-[#5B3E96] dark:bg-[#9B82C1]' : 'bg-slate-300 dark:bg-slate-600'
                        }`}
