export const profilei18n = {
  en: {
    ...
    skillsTitle: '2. Technical Skills & Capabilities',
    skillsDesc: 'Select the technologies your team can deliver. These skills are linked to your account and used for TOR matching.',
    selectedSkills: 'Your selected skills',
    suggestedSkills: 'Popular skills',
    customSkill: 'Add another skill',
    customSkillPlaceholder: 'e.g. Terraform or Spring Boot',
    addSkill: 'Add skill',
    removeSkill: 'Remove skill',
    skillsLimit: 'Add up to 30 skills. Save the profile to apply your changes.',
    sec2Title: '3. Certifications & Statutory Licenses',
    ...
    sec3Title: '4. Vector Match Tuning & Daily Digest Subscriptions',
    ...
    sec4Title: '5. Designated Procurement Officer',
    ...
    savedAlert: 'Vendor profile and skills saved successfully!',
  },
  th: {
    ...
    skillsTitle: '2. ทักษะและความสามารถด้านเทคนิค',
    skillsDesc: 'เลือกเทคโนโลยีที่ทีมของคุณเชี่ยวชาญ ทักษะเหล่านี้จะเชื่อมกับบัญชีและใช้ในการจับคู่ TOR',
    selectedSkills: 'ทักษะที่เลือก',
    suggestedSkills: 'ทักษะแนะนำ',
    customSkill: 'เพิ่มทักษะอื่น',
    customSkillPlaceholder: 'เช่น Terraform หรือ Spring Boot',
    addSkill: 'เพิ่มทักษะ',
    removeSkill: 'ลบทักษะ',
    skillsLimit: 'เพิ่มได้สูงสุด 30 ทักษะ บันทึกโปรไฟล์เพื่อยืนยันการเปลี่ยนแปลง',
    sec2Title: '3. ใบรับรองและใบอนุญาตตามกฎหมาย',
    ...
    sec3Title: '4. การปรับแต่งการจับคู่เวกเตอร์และการรับข่าวสาร',
    ...
    sec4Title: '5. เจ้าหน้าที่ผู้รับผิดชอบการจัดซื้อจัดจ้าง',
    ...
    savedAlert: 'บันทึกโปรไฟล์และทักษะของผู้ขายเรียบร้อยแล้ว!',
  },
};

export type ProfileTranslations = {
  [Key in keyof typeof profilei18n.en]: string;
};
